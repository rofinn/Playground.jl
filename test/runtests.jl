...
main(["exec", joinpath(TEST_DIR, ".playground"), "ls -al"], DEFAULT_CONFIG, TEST_PLAYGROUND_DIR)
main(["list"], DEFAULT_CONFIG, TEST_PLAYGROUND_DIR)
main(["clean"], DEFAULT_CONFIG, TEST_PLAYGROUND_DIR)
main(["rm", joinpath(TEST_DIR, ".playground")], DEFAULT_CONFIG, TEST_PLAYGROUND_DIR)
